...
class ViewBuilder(object):
    ...
    def writeText(self, token):
        ...
        self.buffer.writescope("__io.write(u'")
    ...
    def writeExpression(self, expression):
        ...
        self.buffer.scope += 1
        self.buffer.scopeline("__io.write(unicode(__e))")
    ...
    def maybePrintIndent(self):
        ...
        if len(self.lasttoken[1]) > 0:
            self.buffer.scopeline("__io.write(u'" + self.lasttoken[1] + "')")
    ...
    def maybePrintNewline(self):
        ...
        if not self.lasttoken[0] in no_new_line:
            if self.lasttoken[0] in up_scope:
                self.buffer.scope += 1
            self.buffer.scopeline("__io.write(u'\\n')")
            if self.lasttoken[0] in up_scope:
                self.buffer.scope -= 1
